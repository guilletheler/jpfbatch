...
public class TCPClient {
    ...
    public List<String> communicate(boolean testMode) throws Exception {
        ...
        String hostName = (String) Pub.getParameters().getParamValue("HostName");

        if (hostName == null) {
            hostName = "localhost";
        }

        try (Socket clientSocket = new Socket(hostName, (Integer) Pub.getParameters().getParamValue("TCPPort"))) {
